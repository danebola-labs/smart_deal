...
class SimpleMetricsServiceTest < ActiveSupport::TestCase
  ...
  test 'calculates s3_document_count correctly' do
    with_mock_aws_clients do |_fake_cloudwatch, fake_s3, _fake_rds|
      ...
      fake_s3.objects = [
        S3Object.new(key: 'document1.pdf', size: 50_000), # Valid document
        S3Object.new(key: 'document2.pdf', size: 200_000), # Valid document
        S3Object.new(key: '.hidden.pdf', size: 10_000), # Hidden file (excluded)
